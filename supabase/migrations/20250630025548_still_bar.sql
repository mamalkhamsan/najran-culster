/*
  ...
  1. جداول جديدة
    - `hidden_elements` - جدول العناصر المخفية
  
  2. الصلاحيات
    - إضافة صلاحية `hide_elements` للتحكم في إخفاء العناصر
  
  3. الوظائف
    - إضافة وظيفة للتحقق من حالة إخفاء العنصر
    - إضافة وظيفة لإخفاء عنصر
    - إضافة وظيفة لإلغاء إخفاء عنصر
    - إضافة وظيفة للحصول على جميع العناصر المخفية
*/
...
VALUES (
  'admin-001', 
  'system_update', 
  'إضافة وظيفة إخفاء العناصر', 
  'Added element hiding functionality', 
  '127.0.0.1', 
  '{"feature": "hide_elements", "status": "added"}'
);